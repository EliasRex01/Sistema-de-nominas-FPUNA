...
INSERT INTO PARAMETROS_NOMINA (CLAVE, VALOR_NUM) VALUES ('SALARIO_MINIMO', 2798309);

-- modificaciones para usar filtro de periodos
ALTER TABLE PERIODOS_NOMINA ADD PERIODO DATE;

UPDATE PERIODOS_NOMINA
SET PERIODO = TO_DATE(MES || '/' || ANIO, 'MM/YYYY');

ALTER TABLE PERIODOS_NOMINA DROP COLUMN MES;
ALTER TABLE PERIODOS_NOMINA DROP COLUMN ANIO;

-- modificacion para mostrar el estado de las liquidaciones
ALTER TABLE LIQUIDACION
ADD CONSTRAINT chk_estado_liquidacion
CHECK (ESTADO IN ('PENDIENTE', 'FINALIZADA', 'ANULADA'));
